      ...
      {cart.length > 0 && (
        ...
        >
          ...
          <Modal.Body className="py-2 small">
            <p className="mb-2"><strong>Customer:</strong> {customerName}</p>
            <p className="mb-2"><strong>Agent:</strong> {agent}</p>
            <p className="mb-0"><strong>Total:</strong> ₹{subtotal.toFixed(2)}</p>
          </Modal.Body>
